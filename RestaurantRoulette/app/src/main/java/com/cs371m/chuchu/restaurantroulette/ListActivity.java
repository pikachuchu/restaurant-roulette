...
public class ListActivity extends AppCompatActivity implements SortItemsDialog.SortItemsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ParseUser.getCurrentUser() == null) {
                    ...
                    Intent intent = new Intent(ListActivity.this, CreateEvent.class);
            ...
            public void onClick(View v) {
                if (ParseUser.getCurrentUser() == null) {
                    ...
                    if (nearbyEventsDisplayed) {
                        ListViewAdapter adapter = new ListViewAdapter(ListActivity.this, myEventsList);
                        listView.setAdapter(adapter);
                        button.setText("Nearby Events");
                        title.setText("My Events");
                        nearbyEventsDisplayed = false;
                    } else {
                        ListViewAdapter adapter = new ListViewAdapter(ListActivity.this, nearbyEventsList);
                        listView.setAdapter(adapter);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                Intent intent = new Intent(ListActivity.this, EventDetails.class);
 ...
 @Override
    ...
    private void fetchEvents() {
        final LatLng currLoc = LocationHelper.getCurrentLocation(ListActivity.this);
